...
public enum GuiText implements LocalizationEnum {
    ...
    PatternUpload("Upload Pattern"),
    PatternUploadFavoriteLeftClick("Left-click: Favorite"),
    PatternUploadFavoriteRightClick("Right-click: Open Settings"),
    PatternVirtualCircuit("%s (Circuit %s)"),
    Patterns("Patterns"),
    PatternTooltipSubstitutions("Substitutes alternate items"),
    PatternTooltipFluidSubstitutions("Uses fluids directly"),
    PatternTooltipCatalyst("Catalyst"),
    Pink("Pink"),
    ...
    ForceStartDesc("Start this job even though ingredients are missing. The CPU will wait for them to be supplied."),
    ...
    WaitingForForceStart("Force start waiting for: %s"),
