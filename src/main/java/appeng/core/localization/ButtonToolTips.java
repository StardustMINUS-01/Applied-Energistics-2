...
public enum ButtonToolTips implements LocalizationEnum {
    ...
    EncodeAndUpload("Encode and Upload Pattern"),
    EncodeAndUploadDescription("Left-click: Write the pattern, then upload it to a unique pattern provider."),
    EncodeDescription("Write the entered pattern to the current encoded pattern, or to available blank pattern."),
    RecallLastUploadedPatternDescription("Right-click: Recall your most recently uploaded pattern."),
