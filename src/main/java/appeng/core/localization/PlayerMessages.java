...
public enum PlayerMessages implements LocalizationEnum {
    ...
    Plot("Plot"),
    PatternUploadFailedFull("Pattern providers are full."),
    PatternUploadFailedInvalidPattern("No encoded pattern to upload."),
    PatternUploadFailedMultipleTargets("Choose a target pattern provider."),
    PatternUploadFailedNoGrid("No active ME network."),
    PatternUploadFailedNoTarget("No pattern provider found."),
    PatternUploadFailedUnknown("Pattern upload failed."),
    PatternUploadBatchSummary("Uploaded: %s, full: %s, invalid: %s, failed: %s."),
    PatternUploadRecallFailedNoSpace("No room to recall the uploaded pattern."),
    PatternUploadRecallFailedUnknown("Pattern recall failed."),
    PatternUploadRecallSucceededCursor("Uploaded pattern is now held by the cursor."),
    PatternUploadRecallSucceededInventory("Uploaded pattern returned to your inventory."),
    PatternUploadRecallSucceededResultSlot("Uploaded pattern returned to the encoding result slot."),
    PatternUploadSucceeded("Pattern uploaded."),
